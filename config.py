...
UNIVERSITIES_BY_COUNTRY = {
    'germany': [
        # Art Schools (Kunsthochschulen) - Pure Art Universities
        ...
        # Technical Universities with Strong Design/Art Departments
        ...
        # Major Universities with Art/Design Departments
        ...
        # Fachhochschulen with Art/Design Programs
        'Hochschule für Technik und Wirtschaft Berlin',
        'Hochschule für Technik, Wirtschaft und Kultur Leipzig',
        'Hochschule für Technik und Wirtschaft Dresden',
        'Hochschule für Technik und Wirtschaft Karlsruhe',
        'Hochschule für Technik und Wirtschaft Aalen',
        'Hochschule für Technik und Wirtschaft Augsburg',
        'Hochschule für Technik und Wirtschaft Bingen',
        'Hochschule für Technik und Wirtschaft Darmstadt',
        'Hochschule für Technik und Wirtschaft Deggendorf',
        'Hochschule für Technik und Wirtschaft Dresden',
        'Hochschule für Technik und Wirtschaft Esslingen',
        'Hochschule für Technik und Wirtschaft Gießen-Friedberg',
        'Hochschule für Technik und Wirtschaft Heilbronn',
        'Hochschule für Technik und Wirtschaft Ingolstadt',
        'Hochschule für Technik und Wirtschaft Karlsruhe',
        'Hochschule für Technik und Wirtschaft Köln',
        'Hochschule für Technik und Wirtschaft Lübeck',
        'Hochschule für Technik und Wirtschaft Mannheim',
        'Hochschule für Technik und Wirtschaft München',
        'Hochschule für Technik und Wirtschaft Nürnberg',
        'Hochschule für Technik und Wirtschaft Offenburg',
        'Hochschule für Technik und Wirtschaft Regensburg',
        'Hochschule für Technik und Wirtschaft Rosenheim',
        'Hochschule für Technik und Wirtschaft Stuttgart',
        'Hochschule für Technik und Wirtschaft Ulm',
        'Hochschule für Technik und Wirtschaft Würzburg-Schweinfurt',
        'Hochschule für Technik und Wirtschaft Zwickau',
        
        # Specialized Art/Design Fachhochschulen
        ...
        # Media and Communication Fachhochschulen
        'Hochschule für Medien, Kommunikation und Wirtschaft',
        'Hochschule für Medien Stuttgart',
        'Hochschule für Medien Köln',
        'Hochschule für Medien München',
        'Hochschule für Medien Hamburg',
        'Hochschule für Medien Berlin',
        'Hochschule für Medien Darmstadt',
        'Hochschule für Medien Frankfurt',
        'Hochschule für Medien Hannover',
        'Hochschule für Medien Leipzig',
        'Hochschule für Medien Nürnberg',
        'Hochschule für Medien Stuttgart',
        
        # Applied Sciences Universities with Art Programs
        ...
        'Hochschule für Musik und Theater Lübeck',
        'Hochschule für Musik und Theater Freiburg',
        'Hochschule für Musik und Theater Karlsruhe',
        'Hochschule für Musik und Theater Mannheim',
        'Hochschule für Musik und Theater Nürnberg',
        'Hochschule für Musik und Theater Würzburg',
        'Hochschule für Musik und Theater Detmold',
        'Hochschule für Musik und Theater Köln',
        'Hochschule für Musik und Theater Düsseldorf',
        'Hochschule für Musik und Theater Essen',
        'Hochschule für Musik und Theater Frankfurt',
        'Hochschule für Musik und Theater Mainz',
        'Hochschule für Musik und Theater Saarbrücken',
        'Hochschule für Musik und Theater Trossingen',
        'Hochschule für Musik und Theater Stuttgart',
        'Hochschule für Musik und Theater Augsburg',
        'Hochschule für Musik und Theater Regensburg',
        'Hochschule für Musik und Theater Würzburg',
        'Hochschule für Musik und Theater Nürnberg',
        'Hochschule für Musik und Theater München',
        'Hochschule für Musik und Theater Weimar',
        'Hochschule für Musik und Theater Leipzig',
        'Hochschule für Musik und Theater Dresden',
        'Hochschule für Musik und Theater Berlin',
        'Hochschule für Musik und Theater Hamburg',
        'Hochschule für Musik und Theater Lübeck',
        'Hochschule für Musik und Theater Rostock',
        'Hochschule für Musik und Theater Hannover',
        'Hochschule für Musik und Theater Bremen',
        'Hochschule für Musik und Theater Oldenburg',
        'Hochschule für Musik und Theater Osnabrück',
        'Hochschule für Musik und Theater Münster',
        'Hochschule für Musik und Theater Dortmund',
        'Hochschule für Musik und Theater Essen',
        'Hochschule für Musik und Theater Duisburg',
        'Hochschule für Musik und Theater Köln',
        'Hochschule für Musik und Theater Düsseldorf',
        'Hochschule für Musik und Theater Wuppertal',
        'Hochschule für Musik und Theater Siegen',
        'Hochschule für Musik und Theater Paderborn',
        'Hochschule für Musik und Theater Bielefeld',
        'Hochschule für Musik und Theater Hannover',
        'Hochschule für Musik und Theater Braunschweig',
        'Hochschule für Musik und Theater Hildesheim',
        'Hochschule für Musik und Theater Lüneburg',
        'Hochschule für Musik und Theater Hamburg',
        'Hochschule für Musik und Theater Lübeck',
        'Hochschule für Musik und Theater Kiel',
        'Hochschule für Musik und Theater Flensburg',
        'Hochschule für Musik und Theater Rostock',
        'Hochschule für Musik und Theater Greifswald',
        'Hochschule für Musik und Theater Stralsund',
        'Hochschule für Musik und Theater Neubrandenburg',
        'Hochschule für Musik und Theater Schwerin',
        'Hochschule für Musik und Theater Potsdam',
        'Hochschule für Musik und Theater Berlin',
        'Hochschule für Musik und Theater Cottbus',
        'Hochschule für Musik und Theater Frankfurt (Oder)',
        'Hochschule für Musik und Theater Magdeburg',
        'Hochschule für Musik und Theater Halle',
        'Hochschule für Musik und Theater Dessau',
        'Hochschule für Musik und Theater Weimar',
        'Hochschule für Musik und Theater Jena',
        'Hochschule für Musik und Theater Erfurt',
        'Hochschule für Musik und Theater Gera',
        'Hochschule für Musik und Theater Suhl',
        'Hochschule für Musik und Theater Eisenach',
        'Hochschule für Musik und Theater Meiningen',
        'Hochschule für Musik und Theater Rudolstadt',
        'Hochschule für Musik und Theater Sondershausen',
        'Hochschule für Musik und Theater Gotha',
        'Hochschule für Musik und Theater Arnstadt',
        'Hochschule für Musik und Theater Ilmenau',
        'Hochschule für Musik und Theater Schmalkalden',
        'Hochschule für Musik und Theater Nordhausen',
        'Hochschule für Musik und Theater Mühlhausen',
        'Hochschule für Musik und Theater Sondershausen',
        'Hochschule für Musik und Theater Rudolstadt',
        'Hochschule für Musik und Theater Meiningen',
        'Hochschule für Musik und Theater Eisenach',
